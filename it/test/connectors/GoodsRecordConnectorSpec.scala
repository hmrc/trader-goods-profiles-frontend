...
class GoodsRecordConnectorSpec
  ...
  ".updateCategoryAndComcodeForGoodsRecord" - {
    ...
    "must update a goods record" - {
      "with a category" in {
        ...
        connector
          .updateCategoryAndComcodeForGoodsRecord(testEori, testRecordId, categoryRecord)
          .futureValue
      }
      ...
      "with a category and supplementary unit" in {
        ...
        connector
          .updateCategoryAndComcodeForGoodsRecord(testEori, testRecordId, categoryRecordWithSupp)
          .futureValue
      }
  ...
  ".updateSupplementaryUnitForGoodsRecord" - {
    ...
    "must update a goods record" in {
      ...
      connector
        .updateSupplementaryUnitForGoodsRecord(testEori, testRecordId, supplementaryRequest)
        .futureValue
    }
