...
case object SessionData {
  ...
  val ukimsNumberUpdatePage: String          = "ukimsNumberUpdate"
  val hasNirmsUpdatePage: String             = "hasNirmsUpdate"
  val hasNiphlUpdatePage: String             = "hasNiphlUpdate"
  val nirmsNumberUpdatePage: String          = "nirmsNumberUpdate"
  val niphlNumberUpdatePage: String          = "niphlNumberUpdate"
