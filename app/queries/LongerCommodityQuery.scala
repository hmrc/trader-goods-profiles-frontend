...
case class LongerCommodityQuery(recordId: String) extends Gettable[Commodity] with Settable[Commodity] {

  override def path: JsPath = JsPath \ "longerCommodity" \ recordId
}
