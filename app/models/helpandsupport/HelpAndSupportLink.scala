...
object HelpAndSupportLink {
  ...
  case object GoodsNotAtRisk extends HelpAndSupportLink {
    val link: String = "https://www.gov.uk/guidance/check-if-you-can-declare-goods-you-bring-into-northern-ireland-not-at-risk-of-moving-to-the-eu"
    val linkTextKey: String = "helpAndSupport.p4.linkText"
  }

  case object HMRCContact extends HelpAndSupportLink {
    val link: String = "https://www.gov.uk/government/organisations/hm-revenue-customs/contact/customs-international-trade-and-excise-enquiries"
    val linkTextKey: String = "helpAndSupport.p5.linkText"
  }

  case object FindingCommodityCodes extends HelpAndSupportLink {
    val link: String = "https://www.gov.uk/guidance/finding-commodity-codes-for-imports-or-exports?step-by-step-nav=849f71d1-f290-4a8e-9458-add936efefc5"
  ...
  case object RetailMovementScheme extends HelpAndSupportLink {
    val link: String = "https://www.gov.uk/government/publications/retail-movement-scheme-how-the-scheme-will-work/retail-movement-scheme-how-the-scheme-will-work"
    val linkTextKey: String = "helpAndSupport.p11.linkText"
  }

  case object RegisterAndSeal extends HelpAndSupportLink {
    val link: String = "https://www.gov.uk/guidance/northern-ireland-retail-movement-scheme-how-to-register-and-seal-consignments"
