...
case class MaintainProfileAnswers(
...
object MaintainProfileAnswers {
  implicit val format: OFormat[models.MaintainProfileAnswers] = Json.format[MaintainProfileAnswers]
}
