...
object Condition {
  ...
  implicit val reads: Reads[Condition] =
    ((JsPath \ "type").readNullable[String] and
      (JsPath \ "conditionId").readNullable[String] and
      (JsPath \ "conditionDescription").readNullable[String] and
      (JsPath \ "conditionTraderText").readNullable[String])(Condition.apply _)
