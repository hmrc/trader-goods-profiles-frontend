! function(t, e) {
    ...
    return function() {
        ...
        var t = {
                    ...
                    var r = n(8992),
                        ...
                        l = function(t) {
                            ...
                            return function(h, v, m, y) {
                                for (var g, b, x = u(h), w = i(x), O = a(w), _ = r(v, m), S = 0, C = y || c, E = e ? C(h, O) : n || p ? C(h, 0) : void 0; O > S; S++)
                ...
                9160: function(t, e, n) {
                    ...
                    t.exports = function(t, e) {
                        var n, l, f, p, d, h = t.target,
                            v = t.global,
                            m = t.stat;
                        if (n = v ? r : m ? r[h] || a(h, {}) : r[h] && r[h].prototype)
                            for (l in e) {
                ...
                9292: function(t, e, n) {
                    ...
                    t.exports = !p || u((function() {
                        ...
                        for (var n = l(t), o = arguments.length, u = 1, p = c.f, d = s.f; o > u;)
                            for (var v, m = f(arguments[u++]), y = p ? h(a(m), p(m)) : a(m), g = y.length, b = 0; g > b;) v = y[b++], r && !i(d, m, v) || (n[v] = m[v]);
                        return n
                    } : p
                },
                9368: function(t, e, n) {
                ...
                7680: function(t, e, n) {
                    ...
                    (O || S || _ || d || h) && (y = function(t) {
                        ...
                        if (j && (A = x(A, "y", ""), -1 === b(A, "g") && (A += "g"), k = w(C, d.lastIndex), d.lastIndex > 0 && (!d.multiline || d.multiline && "\n" !== g(C, d.lastIndex - 1)) && (P = "(?: " + P + ")", k = " " + k, N++), n = new RegExp("^(?:" + P + ")", A)), S && (n = new RegExp("^" + P + "$(?!\\s)", A)), O && (r = d.lastIndex), o = i(m, j ? n : d, k), j ? o ? (o.input = w(o.input, N), o[0] = w(o[0], N), o.index = d.lastIndex, d.lastIndex += o[0].length) : d.lastIndex = 0 : O && o && (d.lastIndex = d.global ? o.index + o[0].length : r), S && o && o.length > 1 && i(v, o[0], n, (function() {
                            ...
                            for (o.groups = s = f(null), u = 0; u < I.length; u++) s[(l = I[u])[0]] = o[l[1]];
                        return o
                    }), t.exports = y
                },
                8872: function(t, e, n) {
                ...
                6492: function(t, e, n) {
                    var r = n(1664),
                        ...
                        l = function(t) {
                            return function(e) {
                                var n = i(o(e));
                                return 1 & t && (n = a(n, c, "")), 2 & t && (n = a(n, s, "$1")), n
                            }
                        };
                    t.exports = {
                        start: l(1),
                ...
                7476: function(t, e, n) {
                    ...
                    r({
                        ...
                        concat: function(t) {
                            var e, n, r, o, i, u = a(this),
                                p = f(u, 0),
                                d = 0;
                            for (e = -1, r = arguments.length; e < r; e++)
                                if (y(i = -1 === e ? u : arguments[e]))
                                    for (o = c(i), s(d + o), n = 0; n < o; n++, d++) n in i && l(p, d, i[n]);
                                else s(d + 1), l(p, d++, i);
                            return p.length = d, p
                        }
                    })
        ...
        return function() {
            ...
            n(8752), n(6932), n(4456), n(508), n(232), n(5443), n(9196), n(3536), n(2144), n(9080);
            var t = function() {},
                e = {},
                o = [],
                i = [];
            ...
            function u(n, r) {
                ...
                for (r && null != r.children && (o.length || o.push(r.children), delete r.children); o.length;)
                    if ((a = o.pop()) && void 0 !== a.pop)
                        for (s = a.length; s--;) o.push(a[s]);
                    else "boolean" == typeof a && (a = null), (c = "function" != typeof n) && (null == a ? a = "" : "number" == typeof a ? a = String(a) : "string" != typeof a && (c = !1)), c && u ? l[l.length - 1] += a : l === i ? l = [a] : l.push(a), u = c;
                var f = new t;
            ...
            function E(t, e, n, r, o) {
                ...
                return !_ && p && 1 === p.length && "string" == typeof p[0] && null != l && void 0 !== l.splitText && null == l.nextSibling ? l.nodeValue != p[0] && (l.nodeValue = p[0]) : (p && p.length || null != l) && function(t, e, n, r, o) {
                        ...
                        if (0 !== b)
                            for (x = 0; x < b; x++) {
                                var _;
                                if (s = null, null != (_ = (c = e[x]).key)) d && void 0 !== p[_] && (s = p[_], p[_] = void 0, d--);
                                else if (v < g)
                                    for (i = v; i < g; i++)
                                        if (void 0 !== f[i] && h(u = f[i], c, o)) {
                                            s = u, f[i] = void 0, i === g - 1 && g--, i === v && v++;
                                            break
                                        } s = E(s, c, n, r), a = l[x], s && s !== t && s !== a && (null == a ? t.appendChild(s) : s === a.nextSibling ? y(a) : t.insertBefore(s, a))
                            }
                        if (d)
                            for (var x in p) void 0 !== p[x] && I(p[x], !1);
                        for (; v <= g;) void 0 !== (s = f[g--]) && I(s, !1)
                    }(i, p, n, r, _ || null != f.dangerouslySetInnerHTML),
                    function(t, e, n) {
                        var r;
            ...
            function P(t, e, n) {
                var r, o = A.length;
                for (t.prototype && t.prototype.render ? (r = new t(e, n), M.call(r, e, n)) : ((r = new M(e, n)).constructor = t, r.render = N); o--;)
            ...
            var K = function(t) {
                ...
                return o.isQueryAnOption = function(t, e) {
                    ...
                    var e = this.state,
                        n = e.menuOpen,
                        r = e.selected; - 1 !== r && n && this.handleOptionFocus(r - 1)
                    ...
                    var t, e = this,
                        ...
                        K = r + "__option",
                        z = r + "__hint",
                        $ = this.templateInputValue(I[A]),
                        G = $ && 0 === $.toLowerCase().indexOf(j.toLowerCase()) && k ? j + $.substr(j.length) : "",
                        Q = i + "__assistiveHint",
                        Y = {
                            "aria-describedby": P ? Q : null,
            ...
            var $ = function(t) {
                return function(e, n) {
                    n(t.filter((function(t) {
                        return -1 !== t.toLowerCase().indexOf(e.toLowerCase().trim())
                    })))
                }
            };
