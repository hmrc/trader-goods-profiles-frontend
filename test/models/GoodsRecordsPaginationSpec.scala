    ...
    "when currentPage 1" - {
      ...
      "when totalPages is 2" in {
        ...
        val next               = PaginationLink(
          controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(nextPage).url
        )
        val items              = Seq(
          PaginationItem(
            number = Some(currentPage.toString),
          ...
          PaginationItem(
            ...
            current = Some(false),
            href = controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(nextPage).url,
            ellipsis = Some(false)
          )
        )
        val expectedPagination = Pagination(
      ...
      "when totalPages is 3" in {
        ...
        val items              = Seq(
          ...
          PaginationItem(
            number = Some("3"),
            current = Some(false),
            href = controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(3).url,
            ellipsis = Some(true)
          )
        )
        val expectedPagination = Pagination(
    ...
    "when currentPage 2" - {
      ...
      "when totalPages is 2" in {
        ...
        val prev               = PaginationLink(
          controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(prevPage).url
        )
        val items              = Seq(
          PaginationItem(
            number = Some(prevPage.toString),
            current = Some(false),
            href = controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(prevPage).url,
            ellipsis = Some(false)
          ),
          PaginationItem(
            number = Some(currentPage.toString),
      ...
      "when totalPages is 4" in {
        ...
        val items              = Seq(
          ...
          PaginationItem(
            number = Some("4"),
            current = Some(false),
            href = controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(4).url,
            ellipsis = Some(true)
          )
        )
        val expectedPagination = Pagination(
      ...
      "when totalPages is 3" in {
        ...
        val items              = Seq(
          PaginationItem(
            number = Some("1"),
            current = Some(false),
            href = controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(firstPage).url,
            ellipsis = Some(true)
          ),
          PaginationItem(
            number = Some(prevPage.toString),
      ...
      "when totalPages is 5" in {
        ...
        val items              = Seq(
          ...
          PaginationItem(
            number = Some("5"),
            current = Some(false),
            href = controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(5).url,
            ellipsis = Some(true)
          )
        )
        val expectedPagination = Pagination(
      ...
      "when totalPages is 4" in {
        ...
        val items              = Seq(
          PaginationItem(
            number = Some("2"),
            current = Some(false),
            href = controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(2).url,
            ellipsis = Some(true)
          ),
          PaginationItem(
            number = Some(prevPage.toString),
      ...
      "when totalPages is 6" in {
        ...
        val items              = Seq(
          ...
          PaginationItem(
            number = Some("6"),
            current = Some(false),
            href = controllers.goodsProfile.routes.GoodsRecordsController.onPageLoad(6).url,
            ellipsis = Some(true)
          )
        )
        val expectedPagination = Pagination(
