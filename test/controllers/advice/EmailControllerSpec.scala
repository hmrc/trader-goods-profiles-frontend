...
import forms.advice.EmailFormProvider
...
import views.html.advice.EmailView

import scala.concurrent.Future

class EmailControllerSpec extends SpecBase with MockitoSugar {
  ...
  private lazy val emailRoute = controllers.advice.routes.EmailController.onPageLoad(NormalMode, testRecordId).url
