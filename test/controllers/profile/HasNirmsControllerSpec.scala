...
class HasNirmsControllerSpec extends SpecBase with MockitoSugar {
  ...
  "HasNirmsController" - {
    ...
    ".create" - {
      ...
      val hasNirmsRoute = controllers.profile.routes.HasNirmsController.onPageLoadCreate(NormalMode).url
    ...
    ".update" - {
      ...
      val hasNirmsRoute = controllers.profile.routes.HasNirmsController.onPageLoadUpdate(NormalMode).url
