...
class CreateNiphlNumberControllerSpec extends SpecBase with MockitoSugar {
  ...
  private lazy val niphlNumberRouteCreate = CreateNiphlNumberController.onPageLoad(NormalMode).url

  "CreateNiphlNumberController" - {
